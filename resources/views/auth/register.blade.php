            ...
            <div class="col-12 col-md-8 ms-5">
                <div class="d-flex flex-column align-items-center ">
                        ...
                        <form action="/register" method="POST" role="form" class="php-email-form">
                            ...
                            <div class="form-field-edit form-field space-around my-2">
                                <input type="text" name="name" id="name"
                                    class="form-control forms_field-input" placeholder="Tu nombre" data-rule="minlen:4"
                            ...
                            <div class="form-field-edit form-field space-around my-2">
                                <input type="email" name="email" id="email"
                                    class="form-control forms_field-input" placeholder="Tu correo" data-rule="minlen:4"
                                    data-msg="Please enter at least 4 chars">
                                <div class="validate"></div>
                            </div>
                            <!--Password -->
                            <div class="form-field-edit form-field space-around my-2">
                                <input type="password" name="password" id="password"
                                    class="form-control forms_field-input" placeholder="Tu contraseña">
                                <div class="validate"></div>
                            </div>
                    ...
                    <div class="form-link mt-4 d-flex">
                        ...
                        <a class="text-reset text-decoration-none ps-2" href="{{ route('login') }}"><u>¡Entra
                                ya!</u></a>
                    </div>
                </div>
            </div>
